...
*  SPI.
*/
    GPIOPinWrite(GPIOA1_BASE, 0x2,0x00);  // Set the DC pin low
    SPICSEnable(GSPI_BASE); //enable the SPI Chip select
    MAP_SPIDataPut(GSPI_BASE, c);  // Put the Data
    unsigned long ulDummy;
    MAP_SPIDataGet(GSPI_BASE,&ulDummy);  // Clean up afterward using SPI Data_get
...
*  SPI.
*/
    GPIOPinWrite(GPIOA1_BASE, 0x2,0x2);  // Set the DC pin high
    unsigned long ulDummy;
